...
function seedDatas(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield data_model_1.Review.deleteMany();
            yield data_model_1.Product.deleteMany();
            yield data_model_1.User.deleteMany();
            console.log("After delete");
            const user1 = yield data_model_1.User.create({
                username: "john_doe",
                email: "john@example.com",
                password: "password1",
            });
            const ABCHotel = yield data_model_1.Product.create({
                userId: user1._id,
                category: "restaurant",
                name: "ABC Hotel",
            ...
            yield data_model_1.Review.create([
                {
                ...
                },
                {
                    ...
                    description: "The food was below expectations. The pasta was overcooked, and the service was quite slow. However, the ambiance was nice and the staff was polite.",
                    rating: 2.3,
                    serviceRatings: {
                        "Dine-in": 3.2,
                        Cleanliness: 2,
                ...
                },
                {
                    ...
                    description: "Very disappointing experience. The restaurant was dirty, food was cold, and we had to wait 45 minutes just to get our order taken. Would not recommend.",
                    rating: 1,
                    serviceRatings: {
                        "Dine-in": 3.2,
                        Cleanliness: 1,
            ...
            const OSWatch = yield data_model_1.Product.create({
                userId: user1._id,
            ...
            yield data_model_1.Review.create([
                ...
                },
                {
                    ...
                    description: "Loving the look and features. Battery life could be better, but overall a solid buy.",
                    rating: 4.4,
                    serviceRatings: {
                        Design: 4.7,
                        Durability: 4.2,
                ...
                },
                {
                    ...
                    description: "I was hesitant at first, but this watch won me over. Lightweight, responsive, and elegant.",
                    rating: 4.8,
                    serviceRatings: {
                        Design: 5.0,
                        Durability: 4.6,
                ...
                },
                {
                    ...
                    description: "The features are top-notch, but the strap irritated my skin after a few hours.",
                    rating: 3.6,
                    serviceRatings: {
                        Design: 4.0,
                        Durability: 4.1,
