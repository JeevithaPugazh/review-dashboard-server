...
},
{
  ...
  description:"I had a wonderful experience. Alexander's Caviar treatment is the best nourishing and straightening treatment on the market. It's so gentle. I did not get itchy or teary. The staff is so professional. Gwen was so gentle with my hair and scalp. She took her time carefully straightening the strands from root to tip and didn't disturb my makeup. She is the absolute best. I am so happy I went to this fantastic salon. Alexander, the mastermind behind the Caviar treatment, makes you feel comfortable right from the beginning, and I look forward to returning for the most beautiful hair treatment.",
  rating: 4.3,
  serviceRatings:{"Dine-in":3.2, "Cleanliness":4, "Customer Service":3.2, "Food Quality":2.5},
  sentiment:"positive",
  createdAt:new Date("11/9/2024")
},
{
  productId : ABCHotel._id,
  name:"Anton Kovalov",
  title:"Find a better place if you’re looking for quality appetizers.",
  description:"Plain tasting tartare with bread that was laying around for a long time in the kitchen, when you bite the bread you experience the pain in your teeth. Wine was funky and had cork bits on the bottom.16$ wine, 28$ tartare. Find a better place if you’re looking for quality appetizers.",
  rating: 1,
  serviceRatings:{"Dine-in":1.5, "Cleanliness":1, "Customer Service":1, "Food Quality":1},
  sentiment:"negative",
  createdAt:new Date("13/11/2024")
}
])
...
const OSWatch = await Product.create({
  ...
  services: ["Design", "Durability", "Customer Service", "Value for Money"],
  imageUrl: "./images/OmegaWatch.jpg"
});
...
await Review.create([
  {
    ...
    description: "The Omega Seamaster combines style with functionality. Love the build quality and design.",
    rating: 4.8,
    serviceRatings: {
      "Design": 5,
      "Durability": 4.7,
    ...
    sentiment: "positive",
    createdAt: new Date("12/09/2024")
  },
  {
    productId: OSWatch._id,
    name: "Rachel Kim",
    title: "Looks great but heavy",
    description: "The design is stunning but the watch feels a bit heavy on the wrist after long use.",
    rating: 3.9,
    serviceRatings: {
      "Design": 4.5,
      "Durability": 4.3,
  ...
  },
  {
    ...
    description: "Premium quality. Every detail screams luxury. Would definitely recommend it to watch enthusiasts.",
    rating: 4.6,
    serviceRatings: {
      "Design": 4.8,
      "Durability": 4.9,
    ...
    sentiment: "positive",
    createdAt: new Date("30/11/24")
  },
  {
    productId: OSWatch._id,
    name: "Ethan Blake",
    title: "Disappointed with the battery life",
    description: "For such a premium watch, the battery didn’t even last a year. Expected much better from Omega.",
    rating: 2.0,
    serviceRatings: {
      "Design": 4.0,
      "Durability": 2.1,
  ...
  },
  {
    ...
    description: "Looks nice but feels cheap. The strap broke within 2 months and customer support was not helpful.",
    rating: 2.5,
    serviceRatings: {
      "Design": 3.0,
      "Durability": 1.0,
